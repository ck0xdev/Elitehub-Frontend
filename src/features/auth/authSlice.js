...
export const loginUserAsync = createAsyncThunk('auth/loginUser', async (userData) => {
  ...
  return data; // Returns { id, token, etc. }
});

// NEW: Fetch full user profile (Wishlist/Addresses)
...
// NEW: Update user (Add Address / Wishlist)
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchUserProfileAsync.fulfilled, (state, action) => {
        // Merge profile data (addresses/wishlist) into loggedInUser

  ...
  return (
    <section className="relative w-full min-h-screen flex items-center pt-28 pb-10 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="w-fit">
            <span className="py-2 px-4 rounded-full bg-indigo-100 text-indigo-700 text-sm font-bold tracking-wide uppercase">
              New Arrival
            </span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-lg leading-relaxed">
            Experience the future of mobile technology with the elite collection. Unmatched speed, crystal clear display, and premium design.
          </p>
          
          <div className="flex gap-4 pt-4">
            <button className="flex items-center gap-2 px-8 py-4 bg-gray-900 text-white rounded-full font-semibold shadow-lg hover:shadow-xl hover:bg-gray-800 transition-all transform hover:-translate-y-1">
              Shop Now <ArrowRight size={20} />
            </button>
            <button className="px-8 py-4 bg-white text-gray-900 border border-gray-200 rounded-full font-semibold hover:bg-gray-50 transition-all">
              View Specs
            </button>
          </div>
        </motion.div>
